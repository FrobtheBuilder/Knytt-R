...
local imgfy
do
  local _obj_0 = require("lovekit.image")
  imgfy = _obj_0.imgfy
end
local EffectList
do
  local _obj_0 = require("lovekit.lists")
  EffectList = _obj_0.EffectList
end
local ShakeEffect
do
  local _obj_0 = require("lovekit.effects")
  ShakeEffect = _obj_0.ShakeEffect
end
local smooth_approach
do
  local _obj_0 = require("lovekit.support")
  smooth_approach = _obj_0.smooth_approach
end
local Viewport
do
  local _parent_0 = Box
