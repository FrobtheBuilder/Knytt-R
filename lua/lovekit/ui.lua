...
local COLOR
do
  local _obj_0 = require("lovekit.color")
  COLOR = _obj_0.COLOR
end
local Sequence
do
...
do
  ...
  local _base_0 = {
    ...
    draw = function(self)
      ...
      if self.max_width then
        return g.printf(text, self.x, self.y, self.max_width, self.align)
      else
        return g.print(text, self.x, self.y)
      end
    end
  }
  _base_0.__index = _base_0
...
do
  ...
  local _class_0 = setmetatable({
    __init = function(self, x, y, item)
      return _parent_0.__init(self, x, y, item, "center")
    end,
    __base = _base_0,
    __name = "CenterAnchor",
    __parent = _parent_0
...
do
  ...
  local _class_0 = setmetatable({
    __init = function(self, x, y, w, h, item, xalign, yalign)
      ...
      return _parent_0.__init(self, x, y, w, h)
    end,
    __base = _base_0,
    __name = "Bin",
    __parent = _parent_0
